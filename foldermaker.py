...
folder_structure = {
    'docs': {
        ...
        '12_Future_Trends_and_Community': {
            'Community_Resources': {
...
nav:
    - Home: index.md
"""
    # Creating navigation for each section
    def generate_nav_section(folder, base_dir):
        return {folder: [f"{base_dir}/{folder}/examples/{folder}.md" for folder in os.listdir(base_dir)]}
